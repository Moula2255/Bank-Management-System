...
<body>
    <div class="container">
        ...
        <div class="w-75 m-5">
        <h2 class="responsive">Depoist Form</h2>
        <p class="h4">Currently available balance :<span class="text-success h2 ms-2"><?php echo $a_bal; ?></span></p>
        ...
        <button class="btn btn-primary " name="submit">Depoist</button>
    </div>
    </form>
    </div>
    </div>
